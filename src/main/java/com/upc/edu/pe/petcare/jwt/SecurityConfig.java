...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    @Bean
    public BCryptPasswordEncoder passworddEnconder() {
        BCryptPasswordEncoder bCryptPassworddEncoder = new BCryptPasswordEncoder();
        return bCryptPassworddEncoder;
    }
    ...
    @Autowired
    public void configure(AuthenticationManagerBuilder authe) throws Exception{
        authe.userDetailsService(userDetailsService).passwordEncoder(bcrypt);
    }
