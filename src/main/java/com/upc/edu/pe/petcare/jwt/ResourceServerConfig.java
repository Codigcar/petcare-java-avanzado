...
import com.upc.edu.pe.petcare.jwt.AuthException;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                .exceptionHandling().authenticationEntryPoint(new AuthException())//si se da un error retorno una excepcion personalizado
                .and()
                .requestMatchers()
                .and()
                .authorizeRequests()
